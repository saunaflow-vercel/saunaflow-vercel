...
function Hero({ onDiscover }) {
  ...
  return (
    <header className="hero" ref={heroRef}>
      <div className="hero__bg" ref={bgRef}><img src={asset("assets/hero-mobile-sauna.jpg")} alt="Mobile sauna and cold plunge barrels at a cricket green, dusk" /></div>
      ...
      <div className="wrap">
        <div className="ritual__head">
          <div>
            ...
            <h2 className="ritual__title" style={{ fontSize: "65px" }}>The <span className="up" style={{ fontFamily: "Argue", fontSize: "65px", fontWeight: "300" }}>Experience.</span></h2>
          </div>
